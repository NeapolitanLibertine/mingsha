...
public class Event_Outcome_Counter_Set extends Event_Outcome {
    private static final long serialVersionUID = 7141030001L;
    public String counterName = "";
    public String expStr = "0";
    private int iCivID = -1;

    public Event_Outcome_Counter_Set() {
    }

    public Event_Outcome_Counter_Set(String counterName, String expStr) {
    ...
    public void outcomeAction() {
        try {
            CounterStore.setCounter(this.iCivID, this.counterName, ExpressionProcessor.compute(this.iCivID, this.expStr));
        } catch (Exception e) {
    ...
    public String getConditionText() {
        return "Counter: " + CounterDefs.displayOf(this.counterName) + " = " + this.expStr;
    }
