...
public class Event_Outcome_Counter_Add extends Event_Outcome {
    private static final long serialVersionUID = 7141030002L;
    public String counterName = "";
    private int iValue = 0;
    private int iCivID = -1;

    public Event_Outcome_Counter_Add() {
    }

    public Event_Outcome_Counter_Add(String counterName, int nValue) {
