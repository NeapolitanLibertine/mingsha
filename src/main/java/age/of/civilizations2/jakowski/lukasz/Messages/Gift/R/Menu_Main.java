...
public class Menu_Main extends Menu {
    ...
    public static final int getMenuPosX_Default() {
        return CFG.GAMEWIDTH - getMenuWidth_Default() - CFG.BUTTON_W * 2;
    }

    public static final int getMenuWidth_Default() {
        return CFG.isAndroid() && !CFG.LANDSCAPE ? CFG.CIV_INFO_MENU_WIDTH : CFG.CIV_INFO_MENU_WIDTH + CFG.CIV_INFO_MENU_WIDTH / 2;
    }
    ...
    public Menu_Main() {
        try {
            ...
            int buttonX = getMenuPosX_Default();
            int buttonW = getMenuWidth_Default();
            int nMN = IMGManager.getIMG(gM).getHeight() + IMGManager.getIMG(gM).getWidth();
            menuElements.add(new Button_Classic_LR_Main_Games((String) null, -1, buttonX, tempH, buttonW, CFG.BUTTON_H, true) {
                public void actionElemPPM() {
                    Menu_MM.goBack = View.eMAINMENU;
                    CFG.menus.setMenuID(View.eMM);
                }
            });
            menuElements.add(new Button_Classic_LR_Main((String) null, -1, buttonX, tempH + CFG.BUTTON_H + CFG.PADD, buttonW, CFG.BUTTON_H, true));
            menuElements.add(new Button_Classic_LR_Main((String) null, -1, buttonX, tempH + CFG.BUTTON_H * 3 + CFG.PADD * 3, buttonW, CFG.BUTTON_H, true));
            menuElements.add(new Button_Classic_LR_Main((String) null, -1, buttonX, tempH + CFG.BUTTON_H * 4 + CFG.PADD * 4, buttonW, CFG.BUTTON_H, true) {
            });
            menuElements.add(new Button_Classic_LR_Main((String) null, -1, buttonX, tempH + CFG.BUTTON_H * 5 + CFG.PADD * 5, buttonW, CFG.BUTTON_H, true) {
                public void actionElem(int iID) {
                    CFG.setDialogType(DialogType.START_TUTORIAL);
                }
            });
            if (nMN != 306 && nMN != 278 && nMN != 550) {
                menuElements.add(new Button_Classic_LRMain_DC("Age of History 2: Definitive Edition", (String) null, -1, buttonX, tempH + CFG.BUTTON_H * 6 + CFG.PADD * 6, buttonW, CFG.BUTTON_H, true));
            } else {
                menuElements.add(new Button_Classic_LR_Main((String) null, -1, buttonX, tempH + CFG.BUTTON_H * 6 + CFG.PADD * 6, buttonW, CFG.BUTTON_H, true));
            }

            menuElements.add(new Text("", -1, getMenuPosX_Default() + getMenuWidth_Default() / 2 - (IMGManager.getIMG(Images.gameLogo).getWidth() + CFG.PADD * 4) / 2, ((MenuElemUI) menuElements.get(0)).getPosY() - CFG.PADD - IMGManager.getIMG(Images.mainMenuEdge).getHeight() - CFG.BUTTON_H, IMGManager.getIMG(Images.gameLogo).getWidth() + CFG.PADD * 4, CFG.BUTTON_H) {
                public int getPosXE() {
                ...
                public void drawE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
                    ...
                    if (Menu_Main.GLGO > 2) {
                        if (Menu_Main.this.lTime + (long) Menu_Main.this.ANIMATION_TIME > System.currentTimeMillis()) {
                            ...
                            t = 1.0F - (float) Math.pow((double) (1.0F - t), (double) 6.0F);
            ...
            for (int i = 0; i < menuElements.size(); ++i) {
                if (tRebuildPosY > ((MenuElemUI) menuElements.get(i)).getPosY()) {
            ...
            menuElements.add(new Button_Classic((String) null, -1, CFG.GAMEWIDTH - CFG.BUTTON_H, CFG.GAMEHEIGHT - CFG.BUTTON_H, CFG.BUTTON_H, CFG.BUTTON_H, true) {
            ...
            menuElements.add(new Button_Classic((String) null, -1, CFG.GAMEWIDTH - CFG.BUTTON_H, CFG.GAMEHEIGHT - CFG.BUTTON_H * 2, CFG.BUTTON_H, CFG.BUTTON_H, true) {
                public void drawButtonBGE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                    oSB.setColor(new Color(1.0F, 1.0F, 1.0F, Menu_Main.ICONS_ALPHA));
                    if (Menu_Main.this.lTime + (long) Menu_Main.this.ANIMATION_TIME > System.currentTimeMillis()) {
                        float t = (float) (System.currentTimeMillis() - Menu_Main.this.lTime) / (float) Menu_Main.this.ANIMATION_TIME;
            ...
            menuElements.add(new Button_Classic((String) null, -1, CFG.GAMEWIDTH - CFG.BUTTON_H, CFG.GAMEHEIGHT - CFG.BUTTON_H * 3, CFG.BUTTON_H, CFG.BUTTON_H, true) {
                public void drawButtonBGE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                    oSB.setColor(new Color(1.0F, 1.0F, 1.0F, Menu_Main.ICONS_ALPHA));
            ...
            menuElements.add(new Button_Classic((String) null, -1, CFG.GAMEWIDTH - CFG.BUTTON_H, CFG.GAMEHEIGHT - CFG.BUTTON_H * 4, CFG.BUTTON_H, CFG.BUTTON_H, true) {
                public void drawButtonBGE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                    oSB.setColor(new Color(1.0F, 1.0F, 1.0F, Menu_Main.ICONS_ALPHA));
            ...
            menuElements.add(new Button_Classic((String) null, -1, CFG.GAMEWIDTH - CFG.BUTTON_H, CFG.GAMEHEIGHT - CFG.BUTTON_H * 5, CFG.BUTTON_H, CFG.BUTTON_H, true) {
                public void drawButtonBGE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                    oSB.setColor(new Color(1.0F, 1.0F, 1.0F, Menu_Main.ICONS_ALPHA));
            ...
            menuElements.add(new Button_Classic((String) null, -1, CFG.GAMEWIDTH - CFG.BUTTON_H, CFG.GAMEHEIGHT - CFG.BUTTON_H * 6, CFG.BUTTON_H, CFG.BUTTON_H, true) {
                public void drawButtonBGE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                    oSB.setColor(new Color(1.0F, 1.0F, 1.0F, Menu_Main.ICONS_ALPHA));
    ...
    public final void updateLang() {
        ...
        this.getMenuElem(13).setTextE(CFG.lang.get("Multiplayer"));
        CFG.sTOTAL = CFG.lang.get("Total");
        CFG.sTOTAL_WORLDS_POPULATION = CFG.lang.get("WorldsPopulation");
        CFG.glyphLay.setText((BitmapFont)CFG.fontMain.get(0), CFG.sLoading);
        CFG.iLoadingWidth = (int)CFG.glyphLay.width;
        CFG.glyphLay.setText((BitmapFont)CFG.fontMain.get(CFG.FONT_REGULAR_SMALL), CFG.gLG());
        CFG.iJGW = (int)CFG.glyphLay.width;
        CFG.glyphLay.setText((BitmapFont)CFG.fontMain.get(0), "presents");
        CFG.iJGPW = (int)CFG.glyphLay.width;
        CFG.glyphLay.setText((BitmapFont)CFG.fontMain.get(0), "Age of History 2: Definitive Edition");
    ...
    public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
        try {
            if (Menu_InitGame.animatedSize > 0) {
                ...
                oSB.setColor(new Color(1.0F, 1.0F, 1.0F, 1.0F));
                ((Image)Menu_InitGame.animated.get(Menu_InitGame.animatedID)).draw(oSB, iTranslateX + (CFG.GAMEWIDTH - Menu_InitGame.animatedWidth) / 2, iTranslateY + (CFG.GAMEHEIGHT - Menu_InitGame.animatedHeight) / 2, Menu_InitGame.animatedWidth, Menu_InitGame.animatedHeight);
                oSB.setColor(Color.WHITE);
                if (Menu_InitGame.animatedTime + Menu_InitGame.animatedFrame < CFG.currentTimeMillis) {
                    ++Menu_InitGame.animatedID;
        ...
        if (SPECIAL_1) {
            ...
            if (!this.sF.isEmpty()) {
                ...
                for(int i = this.sF.size() - 1; i >= 0; --i) {
                    if (((FSF)this.sF.get(i)).iH > 0) {
                        ((FSF)this.sF.get(i)).update(CFG.GAMEWIDTH, CFG.GAMEHEIGHT);
                        CFG.core.getCiv(((FSF)this.sF.get(i)).c).getFlagC().draw(oSB, iTranslateX + ((FSF)this.sF.get(i)).x, iTranslateY + ((FSF)this.sF.get(i)).y, ((FSF)this.sF.get(i)).iW, ((FSF)this.sF.get(i)).iH);
                        if (((FSF)this.sF.get(i)).iH <= 1) {
                            this.sF.remove(i);
                        }
                    } else {
                        this.sF.remove(i);
