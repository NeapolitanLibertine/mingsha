...
public class Event_Outcome_Counter_Mul extends Event_Outcome {
    private static final long serialVersionUID = 7141030004L;
    public String counterName = "";
    private int iValue = 0;
    private int iCivID = -1;

    public Event_Outcome_Counter_Mul() {
    }

    public Event_Outcome_Counter_Mul(String counterName, int nValue) {
