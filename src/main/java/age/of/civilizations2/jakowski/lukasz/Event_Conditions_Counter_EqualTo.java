...
public class Event_Conditions_Counter_EqualTo extends Event_Conditions {
    private static final long serialVersionUID = 7141020001L;
    private String counterName = "";
    private int iValue = 0;
    private int iCivID = -1;

    public Event_Conditions_Counter_EqualTo() {
    }

    public Event_Conditions_Counter_EqualTo(String counterName, int nValue) {
