...
public class Menu_InGame_MissionsReal extends Menu {
    public Menu_InGame_MissionsReal() {
        ...
        try {
            ...
            int added = 0;
            menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Workshop Explorer", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                public void actionElem(int iID) {
            ...
            tY += menuElements.get(menuElements.size() - 1).getHeightE();
            menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Do Nothing.. Win", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                public void actionElem(int iID) {
            ...
            menuElements.get(menuElements.size() - 1).setMin(added++);
            tY += menuElements.get(menuElements.size() - 1).getHeightE();
            menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Who Wants to Rule the World? Quiz", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                public void actionElem(int iID) {
            ...
            menuElements.get(menuElements.size() - 1).setMin(added++);
            tY += menuElements.get(menuElements.size() - 1).getHeightE();
            menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Win a game of Battleship", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                public void actionElem(int iID) {
            ...
            menuElements.get(menuElements.size() - 1).setMin(added++);
            tY += menuElements.get(menuElements.size() - 1).getHeightE();
            menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Fix the Bugs!", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                public void actionElem(int iID) {
            ...
            tY += menuElements.get(menuElements.size() - 1).getHeightE();
            if(CFG.getIsDesktop()) {
                menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Become the longest flag snake!", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                    public void actionElem(int iID) {
            ...
            menuElements.add(new Button_DiplomacyAction_TextRight(Images.diploMessage, "Touch Grass", 0, 0, tY, CFG.BUTTON_W, tempElemH, true, "", Images.key) {
                public void actionElem(int iID) {
            ...
            menuElements.get(menuElements.size() - 1).setMin(added++);
            int var29 = tY + menuElements.get(menuElements.size() - 1).getHeightE();
        } catch (Exception exr) {
