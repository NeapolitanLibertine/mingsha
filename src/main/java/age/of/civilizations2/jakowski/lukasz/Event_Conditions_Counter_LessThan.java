...
public class Event_Conditions_Counter_LessThan extends Event_Conditions {
    private static final long serialVersionUID = 7141020002L;
    private String counterName = "";
    private int iValue = 0;
    private int iCivID = -1;

    public Event_Conditions_Counter_LessThan() {
    }

    public Event_Conditions_Counter_LessThan(String counterName, int nValue) {
