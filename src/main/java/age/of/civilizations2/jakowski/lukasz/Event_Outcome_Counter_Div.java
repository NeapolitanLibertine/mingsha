...
public class Event_Outcome_Counter_Div extends Event_Outcome {
    private static final long serialVersionUID = 7141030005L;
    public String counterName = "";
    private int iValue = 1;
    private int iCivID = -1;

    public Event_Outcome_Counter_Div() {
    }

    public Event_Outcome_Counter_Div(String counterName, int nValue) {
